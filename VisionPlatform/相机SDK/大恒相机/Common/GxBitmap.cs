...
namespace GxIAPINET.Sample.Common
{
    public class GxBitmap
    {
            ...
            if (null != objIBaseData)
            {
                if (GX_FRAME_STATUS_LIST.GX_FRAME_STATUS_SUCCESS == objIBaseData.GetStatus())
                {
                    if (m_bIsColor)
                    {
                        ...
                        m_tmFun.GetImageFromCam(EnumData.CamColor.color, pBufferColor, m_nWidth, m_nHeigh, "bgr");
                    }
                    else
                    {
                        ...
                        m_tmFun.GetImageFromCam(EnumData.CamColor.mono, pBufferMono, m_nWidth, m_nHeigh, "bgr");
        ...
        public void Show(IBaseData objIBaseData)
        {
            ...
            if (null != objIBaseData && null != m_tmFun)
            {
